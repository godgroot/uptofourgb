...
BOT_PICS = (environ.get('PICS', 'https://telegra.ph/file/f256192ba4718a466a72e.jpg')).split()
SUPPORT = environ.get("SUPPORT", "https://t.me/isaiminilink")
...
DEV_NAME = environ.get("DEV_NAME", "@Illaya_Tholan")
